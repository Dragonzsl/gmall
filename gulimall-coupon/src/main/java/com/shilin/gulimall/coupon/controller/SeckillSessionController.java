package com.shilin.gulimall.coupon.controller;
...
public class SeckillSessionController {
    ...
    @GetMapping("/getSeckillSession")
    public R getSeckillSession(){
        List<SeckillSessionEntity> sessionEntities = seckillSessionService.getSeckillSession();
